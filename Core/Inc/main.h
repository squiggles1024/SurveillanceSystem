...
#define TEMP_THREAD_STACK_SIZE 700
#define HUM_THREAD_STACK_SIZE 600
#define MAG_THREAD_STACK_SIZE 600
#define LIGHT_THREAD_STACK_SIZE 600
#define PRES_THREAD_STACK_SIZE 500
#define MOT_THREAD_STACK_SIZE 700
#define TOTAL_APP_STACK_SIZE 1024 + LED_STACK_SIZE*2 + TEMP_THREAD_STACK_SIZE + HUM_THREAD_STACK_SIZE + MAG_THREAD_STACK_SIZE + LIGHT_THREAD_STACK_SIZE + PRES_THREAD_STACK_SIZE + MOT_THREAD_STACK_SIZE
