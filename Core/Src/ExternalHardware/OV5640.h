...
typedef struct{
    ...
    void    (*Init)(void);
    void    (*DeInit)(void);
    int32_t (*Write)(uint16_t, uint16_t, uint8_t*, uint16_t);
    int32_t (*Read)(uint16_t, uint16_t, uint8_t*, uint16_t);
    uint32_t (*GetTick)(void);
}OV5640_IO_t;

typedef struct{
    int32_t (*Write)(void*, uint16_t, uint8_t*, uint16_t);
    int32_t (*Read) (void*, uint16_t, uint8_t*, uint16_t);
    void *Handle;
}OV5650_Context_t;

typedef struct{
	OV5640_IO_t IO;
	OV5650_Context_t Context;
}OV5640_Handle_t;
...
typedef struct
{
  int32_t (*Init)(OV5640_Handle_t *, uint32_t, uint32_t);
  int32_t (*DeInit)(OV5640_Handle_t *);
  int32_t (*ReadID)(OV5640_Handle_t *, uint32_t *);
  int32_t (*GetCapabilities)(OV5640_Handle_t *, OV5640_Capabilities_t *);
  int32_t (*SetLightMode)(OV5640_Handle_t *, uint32_t);
  int32_t (*SetColorEffect)(OV5640_Handle_t *, uint32_t);
  int32_t (*SetBrightness)(OV5640_Handle_t *, int32_t);
  int32_t (*SetSaturation)(OV5640_Handle_t *, int32_t);
  int32_t (*SetContrast)(OV5640_Handle_t *, int32_t);
  int32_t (*SetHueDegree)(OV5640_Handle_t *, int32_t);
  int32_t (*MirrorFlipConfig)(OV5640_Handle_t *, uint32_t);
  int32_t (*ZoomConfig)(OV5640_Handle_t *, uint32_t);
  int32_t (*SetResolution)(OV5640_Handle_t *, uint32_t);
  int32_t (*GetResolution)(OV5640_Handle_t *, uint32_t *);
  int32_t (*SetPixelFormat)(OV5640_Handle_t *, uint32_t);
  int32_t (*GetPixelFormat)(OV5640_Handle_t *, uint32_t *);
  int32_t (*NightModeConfig)(OV5640_Handle_t *, uint32_t);
} OV5640_CAMERA_Drv_t;
...
int32_t OV5640_SetPolarities(OV5640_Handle_t *OV5640, uint32_t PclkPolarity, uint32_t HrefPolarity, uint32_t VsyncPolarity);
