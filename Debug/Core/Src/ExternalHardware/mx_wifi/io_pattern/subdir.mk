...
C_SRCS += \
../Core/Src/ExternalHardware/mx_wifi/io_pattern/mx_wifi_spi.c 

OBJS += \
./Core/Src/ExternalHardware/mx_wifi/io_pattern/mx_wifi_spi.o 

C_DEPS += \
./Core/Src/ExternalHardware/mx_wifi/io_pattern/mx_wifi_spi.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/ExternalHardware/mx_wifi/io_pattern/%.o Core/Src/ExternalHardware/mx_wifi/io_pattern/%.su: ../Core/Src/ExternalHardware/mx_wifi/io_pattern/%.c Core/Src/ExternalHardware/mx_wifi/io_pattern/subdir.mk
...
clean: clean-Core-2f-Src-2f-ExternalHardware-2f-mx_wifi-2f-io_pattern

clean-Core-2f-Src-2f-ExternalHardware-2f-mx_wifi-2f-io_pattern:
	-$(RM) ./Core/Src/ExternalHardware/mx_wifi/io_pattern/mx_wifi_spi.d ./Core/Src/ExternalHardware/mx_wifi/io_pattern/mx_wifi_spi.o ./Core/Src/ExternalHardware/mx_wifi/io_pattern/mx_wifi_spi.su

.PHONY: clean-Core-2f-Src-2f-ExternalHardware-2f-mx_wifi-2f-io_pattern
